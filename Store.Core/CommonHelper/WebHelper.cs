    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetThisPageUrl(bool includeQueryString, bool useSsl)
        {
            ...
            if (includeQueryString)
            {
                ...
                string storeHost = _httpContext.Request.UserHostName;
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["ArjGostar.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["ArjGostar.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["ArjGostar.IsPOSTBeingDone"] = value;
            }
        }
