...
namespace Store.Service.Stores
{
    public class PositionTypeService : IPositionTypeService
    {
        ...
        public void Insert(PositionType entity)
        {
        ...
        public void Update(PositionType entity)
        {
        ...
        public List<PositionType> FilterData(int start, int lenght, string search, int sortColumn, string sortDirection, DateTime? createDate = null, DateTime? editDate = null,string title=null)
        {
        ...
        public List<PositionType> GetAll(string title=null)
        {
