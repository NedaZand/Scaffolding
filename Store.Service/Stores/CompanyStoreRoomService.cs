...
{
    public class CompanyStoreRoomService : ICompanyStoreRoomService
    {
        private readonly IRepository<CompanyStoreRoom> _repository;
        private readonly StoreContext _context;

        public CompanyStoreRoomService(IRepository<CompanyStoreRoom> repository)
        {
            _repository = repository;
            _context = new StoreContext();
        }
        public void Insert(CompanyStoreRoom entity)
        {
            _repository.Insert(entity);
        }
        public void Remove(CompanyStoreRoom entity)
        {
            _repository.Remove(entity);
        }
        public void Update(CompanyStoreRoom entity)
        {
            _repository.Edit(entity);
        }
        
        public CompanyStoreRoom GetById(int id)
        {
            return _repository.GetById(id);
        }
        public List<CompanyStoreRoom> FilterData(int start, int lenght, string search, int sortColumn, string sortDirection, DateTime? createDate = null, DateTime? editDate = null,string title=null)
        {
        ...
        public List<CompanyStoreRoom> GetAll(string title=null)
        {
            var list = _repository.Entities.OrderByDescending(x => x.CreatedDate).ToList();
